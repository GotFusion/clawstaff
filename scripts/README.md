...
## 子目录职责
- `learning/`：学习层离线回填与资产迁移脚本，包括 `InteractionTurn` / `NextStateEvidence` 生成、`SEM-101` raw-event action builder、`semantic_actions` SQLite 回填，以及 learning bundle 的导出、校验、恢复。
